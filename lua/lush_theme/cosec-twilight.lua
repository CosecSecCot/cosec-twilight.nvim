...
local theme = lush(function(injected_functions)
    ...
    return {
        ...
        -- Telescope
        TelescopeNormal           { fg = Normal.fg, bg = darkgrey },
        TelescopeBorder           { fg = TelescopeNormal.bg, bg = TelescopeNormal.bg },

        TelescopePromptTitle      { fg = TelescopeNormal.bg, bg = light_violet },
        -- TelescopePromptBorder  { },
        -- TelescopePromptNormal  { },
        TelescopePromptCounter    { fg = grey },

        TelescopeResultsTitle     { fg = dark_violet.da(50), bg = dark_violet },
        -- TelescopeResultsBorder { },

        -- TelescopePreviewNormal { },
        -- TelescopePreviewBorder { },
        TelescopePreviewLine      { fg = nil, bg = TelescopeNormal.bg.li(10) },
        TelescopePreviewTitle     { TelescopeResultsTitle },
